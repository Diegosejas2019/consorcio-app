...
const ADMIN_NAV_GROUPS = {
  finanzas: {
    label: 'Finanzas',
    pages: ['page-admin-dashboard', 'page-admin-expenses'],
    items: [
  ...
  comunidad: {
    label: 'Comunidad',
    pages: ['page-admin-owners', 'page-admin-notices', 'page-admin-claims'],
    items: [
...
export function setupNav() {
  ...
  if (state.role === 'admin') {
    ...
    nav.innerHTML = `
      ...
      <button class="nav-item" data-pages="page-admin-owners,page-admin-notices,page-admin-claims" onclick="navToggleGroup('comunidad')">${SVG.users}<span>Comunidad</span></button>
