...
import { renderOwnerDocuments }    from './js/pages/owner/documents.js';
...
PAGE_RENDERERS['page-admin-admins']    = () => renderAdminAdministrators();
PAGE_RENDERERS['page-admin-expenses']  = () => renderAdminExpenses();
PAGE_RENDERERS['page-admin-providers'] = () => renderAdminProviders();
PAGE_RENDERERS['page-admin-documents'] = () => renderAdminDocuments();
...
PAGE_RENDERERS['page-admin-visits-log']    = () => renderAdminVisitsLog();
...
PAGE_RENDERERS['page-owner-documents'] = () => renderOwnerDocuments();
